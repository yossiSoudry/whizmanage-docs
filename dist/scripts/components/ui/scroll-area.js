...
const ScrollArea = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (_jsxs(ScrollAreaPrimitive.Root, { ref: ref, className: cn("relative overflow-hidden", className), ...props, children: [_jsx(ScrollAreaPrimitive.Viewport, { className: cn("h-full w-full rounded-[inherit]", isRTL && "rtl-viewport"), children: children }), _jsx(ScrollBar, {}), _jsx(ScrollAreaPrimitive.Corner, {})] }));
});
...
const ScrollBar = React.forwardRef(({ className, orientation = "vertical", ...props }, ref) => (_jsx(ScrollAreaPrimitive.ScrollAreaScrollbar, { ref: ref, orientation: orientation, className: cn("flex touch-none select-none transition-colors", orientation === "vertical" &&
        "h-full w-2.5 border-l border-l-transparent p-[1px] rtl:border-l-0 rtl:border-r rtl:border-r-transparent", orientation === "horizontal" &&
