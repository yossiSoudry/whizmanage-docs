---
title: מבוא
description: "ברוכים הבאים למרכז המידע של Whizmanage! כאן תמצאו את כל המידע הדרוש לניהול יעיל של המערכת שלכם. המדריכים שלנו מכסים את כל הפונקציונליות של המערכת - החל מהגדרות בסיסיות, דרך ניהול משימות וצוותים, ועד לתכונות מתקדמות ואוטומציות. בין אם אתם מתחילים את דרככם ב-Whizmanage או מחפשים לשפר את השימוש במערכת, המדריכים המפורטים שלנו יסייעו לכם להפיק את המירב מהפלטפורמה."
